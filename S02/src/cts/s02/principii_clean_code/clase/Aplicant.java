...
public abstract class Aplicant {
	...
	private static int pragAcceptare = 60;
	...
	public void setNrProiecte(int numarProiecte, String[] denumiriProiecte) {
		this.numarProiecte = numarProiecte;
	...
	public  void afisareFinantare(int sumaFinantare, String tipPersoana){
		System.out.println(tipPersoana + getNume() + " " + getPrenume() + "primeste" + sumaFinantare + " Euro/zi");
	}
